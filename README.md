...
- [Что не используется](#-------------------)
  * [Локаторы](#--------)
    + [Использование не UI аннотаций](#-----------------ui----------)
    + [Возможности аннотации UI](#----------------------ui)
- [Поддержка фрэймворков](#---------------------)
  ...
  * [Реализация кастомных элементов](#------------------------------)
    ...
    + [Написание элемента](#------------------)
    + [Обзор UIElement и его иерархии](#------uielement---------------)
      - [Интерфейс JDIElement](#----------jdielement)
      - [Класс DriverBase](#------driverbase)
      - [Интерфейс IBaseElement](#----------ibaseelement)
      - [Класс JDIBase](#------jdibase)
      - [Интерфейс WebElement](#----------webelement)
      - [Интерфейс HasAssert\<A>](#----------hasassert--a-)
      - [Другие интерфейсы](#-----------------)
      - [Класс UIElement](#------uielement)
    + [Обзор UIBaseElement и прикладных классов](#------uibaseelement---------------------)
      - [Интерфейс ICoreElement](#----------icoreelement)
      - [Расширение функционала элемента](#-------------------------------)
      - [Класс UIListBase\<A>](#------uilistbase--a-)
    + [Дженерики стандартных элементов](#-------------------------------)
      - [Понижающее приведение](#---------------------)
      - [Как это работает в JDI Light](#-------------------jdi-light)
    + [Написание complex элемента со своими аннотациями](#----------complex-------------------------------)
    + [Частые ошибки](#-------------)
      ...
      - [Написание assert методов неговорящих о типе ошибки](#----------assert----------------------------------)
- [Краткий обзор магии JDI](#--------------------jdi)
  * [Зачем пересобирать модуль(-и)](#-----------------------------)
    + [Аспектно-ориентированное программирование](#-----------------------------------------)
    + [Принципы реализации АОП](#-----------------------)
    + [Аспекты в JDI Light](#----------jdi-light)
    + [Реализация ожиданий](#-------------------)
    + [Выводы](#------)
  * [Обзор JDI Lightsaber](#------jdi-lightsaber)
